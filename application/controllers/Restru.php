...
class Restru extends CI_Controller {
    ...
    public function delete_data_restru()
    {
       ...
       //ar_dump($selection);
        ...
        $this->ModelRestru->delete_all_restru($selection);

        $this->sucess_notif_delete();

        redirect('Restru/index');    }

    public function delete_retruktur_edit()
    {
        $selection = $this->input->post('idnya');
        // $cifid = $selection;
        // $cif = explode("-", $cifid);
       ...
       //ar_dump($selection);
        ...
        $this->ModelRestru->deleteupdate_restru($selection);
    ...
    public function updatemodal_restru() {
            ...
            $restrukturke=$this->input->post('restruktur_ke');
            ...
            $this->ModelRestru->restru_updatemodal($cif_nsb,$restrukturke,$data,$idnya);
    ...
    public function updateImagedelete() {
        ...
        $idnya= $this->input->post('idnya[]');
            if($idnya !=''){
                ...
                redirect('Restru/view_image');}else{
                    $this->gagalhapus();
                    redirect('Restru/view_image');
                }
        }
...
function sucess_notif_updateimage() {
  ...
  function notif_formatfile_restruk() {
    ...
    function notif_file() {
        ...
        position: 'top',
        title:'Gagal!',
        text: 'Hanya Bisa format JPG AND PNG!!!',
        type: 'error'
        })</script>"
        );
    }
    ...
    function sucess_notif_delete() {
        ...
        position: 'top',
        title: 'Berhasil!',
        text: 'Berhasil Delete Data Restrukturisasi!!!',
        type: 'success',
        showConfirmButton: false,
        timer: 6500,
        onOpen: function () {
