                    ...
                    <div class="panel panel-success ">
                        <div class="row">
                            <div class="col-md-12 mx-auto">
                                <form action="<?php echo base_url('Create_document_about/update_docabout') ?>" method="POST"
                                        ...
                                        <div class="panel-body">
                                            <div class="panel-heading" style="background-color:#1f3983">
                                                <h4 class="panel-title " style="color:white"><i
                                                        ...
                                                        ;></i>edit Data About</h4>
                                            </div>
                                            <div class="col-sm-11">
                                                <br>

                                                    <input  name="id_docnews" id="id_docnews" autocomplete="off"
                                                    value="<?php echo $v_datanews->id_docabout ?>" title="erorr" align="right"
                                                    class="form-control" type="hidden" placeholder="Judul" required ">

                                                    <input  name="code_image" id="code_image" autocomplete="off"
                                                    value="<?php echo $v_datanews->code_image ?>" title="erorr" align="right"
                                                    class="form-control" type="hidden" placeholder="Judul" required ">

                                                    <input name="judul" id="judul" autocomplete="off"
                                                    value="<?php echo $v_datanews->judul ?>" title="erorr" align="right"
                                                    class="form-control" type="text" placeholder="Judul" required ">
                                
                                        <br>
                                <div class=" col-lg-11 col-md-9"style="width: 112%; ">
                                                <div style=" height: 50%;" id="" class="summernote1"><?php echo $v_datanews->description ?></div>
                                                </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-sm-12">
                                ...
                                <div class="panel panel-success ">
                                    ...
                                    <div class="panel-body">
                                        <input type='file' value="<?php echo base_url('uploads/' . $v_datanews->file_content)?>" multiple="multiple" required="" class="form-control"
                                            id="blah[]" name="myfile[]" onchange="readURL(this);" /><img id="blah"
                                            src="<?php echo base_url('uploads/' . $v_datanews->file_content)?>"
                                            alt="your image" />
