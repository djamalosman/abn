    ...
    <![endif]-->
        <div id="header" class="header-fixed">
            ...
            <div class="container">
                ...
                <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url('Create_document/v_all_doc_news') ?>">NEWS</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('Create_document_video/v_all_doc_video') ?>">VIDEO</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('Create_document_image/v_all_doc_image') ?>">GALLERY</a>
                        </li>
                        <li>
            ...
            <section class="white-bg blog-item">
                <div class="container">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="blog-post">
                            <!-- Start .blogpost -->
                            <h2 class="blog-post-title"><?php echo $v_one_tokoh->nama_asli ?></h2>
                            <div class="blog-meta">
                                <span class="date">
                        <a href="#">
                            <i class="fa fa-calendar"></i>
                            <?php echo $v_one_tokoh->tanggal_insert ?>
                        </a>
                    </span>
                        ...
                        <a href="#">
                            ...
                            <div class="img-holder">
                                <a href="#l">
                                    <div class="bg-img-holder">
                                        <img src="<?php echo base_url('uploads/' . $v_one_tokoh->file_content)?>" alt="blog post">
                                    </div>
                                </a>
                            </div>
                            <div class="blog-post-content">
                                <p>
                                    ...
                                    <?php echo $v_one_tokoh->description ?>
                                </p>
                                <!-- / .row -->
                            </div>
                        </div>
                    ...
                    <!-- col-md-8 end here -->
                    <div class="sidebar sidebar-right col-md-3">
                        <!-- col-md-4 start here -->
                        <div class="sidebar-widget">
                            <div class="tabs simple-tabs">
                                ...
                                <ul id="rstab" class="nav nav-tabs nav-justified mb0">
                                    <li class="active">
                                        <a href="#popular-posts" data-toggle="tab"><i class="fa fa-heart"></i>Post </a>
                                    </li>
                                ...
                                <div id="rstab-content" class="tab-content">
                                    <div class="tab-pane fade active in" id="popular-posts">
                                            ...
                                            <?php foreach($v_one_tokoh_result as $one_toko_result) { ?>
                                                    <li>
                                                    <div class="img-holder mix other"style="height: 275px;">
                                                        <a href="<?php echo base_url("C_one_doc_news/v_one_news/" . $one_toko_result->code_image . '-' . $one_toko_result->id_doctokoh) ?>">
                                                        <img src="<?php echo base_url('uploads/' . $one_toko_result->file_content)?>" class="diva" alt="blog post">
                                                        </a>
                                                        <div class="img-hover text-center"style="width: 260px;height: 255px;">
                                                            <a href="<?php echo base_url("C_one_doc_news/v_one_news/" . $one_toko_result->code_image . '-' . $one_toko_result->id_doctokoh) ?>">
                                                            <div class="img-hover-content">
                                                                <h5><?php echo $one_toko_result->jabatan ?></h5>
                                                            </div>
                                                            </a>
                                                        </div>
                                                        <div class="blog-meta icon-cog">
                                                            <a href="#">
                                                                <i class="fa fa-comments icon-cog"></i> 
                                                            </a>
                                                        </div>
                                                    </div>
                                                    </li>
                        ...
                        <div class="sidebar-widget">
                            <h2 class="sidebar-widget-title"></h2>
        ...
        <div id="footer">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 footer-column">
                        ...
                        <p class="mb20">Only creative ideas &amp; and quality standarts</p>
                        <div class="footer-map">
                            <address>
                                <strong>Head Office:</strong>
                                <br>356 Spain, office 247
                                <br>Barcelona, SP 94107
                                <br>
                            </address>
                            <abbr title="Phone Number"><strong>Phone:</strong>
                            </abbr>(52) 3543 25478
                            <br>
                            <abbr title="Fax"><strong>Fax:</strong>
                            </abbr>(52) 7025 56584
                            <br>
                            <abbr title="Email Address"><strong>Email:</strong>
                            </abbr>web@dynamic.com
                        </div>
                    </div>
                    <!-- col-md-4 end here -->
                    <div class="col-md-4 footer-column">
                        <!-- col-md-4 start here -->
                        <h4 class="footer-column-title">Recent posts</h4>
                        <ul class="list-unstyled">
                            ...
                            <li class="blog-list">
                                <div class="blog-title">
                                    <h5><a href="#">Find the perfect spot when parking your car</a>
                                    </h5>
                                </div>
                                <div class="blog-meta">
                                    <span class="date">
                            ...
                            <li class="blog-list">
                                <div class="blog-title">
                                    <h5><a href="#">What we need to know when do laundry in public spots</a>
                                    </h5>
                                </div>
                                <div class="blog-meta">
                                    <span class="date">
            ...
            <div class="footer-copyright">
                <div class="container">
                    <p class="pull-left">
                        Copyrights © 2014 <a href="http://suggeelson.com/" class="strong" target="_blank">SuggeElson</a>. All rights reserved.
                    </p>
                    <p class="pull-right">
...
<![endif]-->
        ...
        <script src="<?php echo base_url('assets/frontend/js/pages/blank.js')?>"></script>
    </body>
</html>