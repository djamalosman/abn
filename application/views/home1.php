            ...
            <aside id="left-panel" class="left-panel kiri" style="background: black; color: white; font-weight: bold">
                <nav class="navbar navbar-expand-sm navbar-default">
                    <div class="navbar-header" style="background: black;">
                        ...
                        <a class="navbar-brand logo-al  d-inline-block d-sm-none" href=""><img class="logo-al" style="height: 30px" src="<?php echo base_url("template/images/main_logo.jpg") ?>" alt="Logo"></a>
                        <div style="width: 100%; height: auto; background: #7F0000; margin-top: 5px">
                            ...
                            <img  id="main-logo" style="width: 100%; height: auto;" class="logo-sm-hidelah navbar-brand d-none d-sm-block" src="<?php echo base_url("template/images/main_logo.jpg") ?>" alt="Logo">
                        </div>
                    ...
                    <div id="main-menu" class="main-menu collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li class="active lebar" style="background: black;"> <!--style="width: 300px"-->
                                <a title="Dashboard" href="<?php echo base_url("menu/home") ?>"><i id="dshboard" class="menu-icon fa fa-dashboard d-none"></i>C24System | Collection System</a>
                            </li>
                            ...
                            <?php foreach ($data as $key=>$item) { ?>
                                ...
                                <li class="menu-item-has-children dropdown" style="background: black;">
                                    ...
                                    <a href="#" class="link-menu dropdown-toggle" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false" title="<?php echo $item->f_menuname ?>"> <i class="menu-icon <?php echo $item->icon ?>"></i><?php echo $item->f_menuname ?></a>
                                    <ul class="sub-menu children dropdown-menu" id="floating-pilihan">
                                <?php } ?>
                                        <li><i  style="font-size: 10pt" class="fa fa-angle-double-right"></i><a href="<?php echo base_url($item->f_itemurl) ?>" style="font-size: 10pt; font-weight: lighter"><?php echo $item->f_itemname ?></a></li>  
