            ...
            <section class="white-bg blog-item">
                <div class="container">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="blog-post">
                            <!-- Start .blogpost -->
                            <h2 class="blog-post-title"><?php echo '' ?></h2>
                            <div class="blog-meta">
                                <span class="date">
                        <a href="#">
                            ...
                            <div class="img-holder">
                                <a href="blog-item.html">
                                    <div class="bg-img-holder">
                                        <img src="<?php echo base_url('uploads/' . $one_agenda->file_content)?>" alt="blog post">
                                    </div>
                                </a>
                            </div>
                            <div class="blog-post-content">
                                <p>
                                    <?php echo $one_agenda->description ?>
                                </p>
                                <!-- / .row -->
                            </div>
                        </div>
                        ...
                        <div class="sidebar-widget">
                            <div class="tabs simple-tabs">
                                ...
                                <ul id="rstab" class="nav nav-tabs nav-justified mb0">
                                    <li class="active">
                                        <a href="#popular-posts" data-toggle="tab"><i class="fa fa-newspaper-o"></i>Post</a>
                                    </li>
                                    <!-- <li>
                                ...
                                <div id="rstab-content" class="tab-content">
                                    <div class="tab-pane fade active in" id="popular-posts">
                                            <ul class="blog-list-small">
                                                <?php foreach($v_one_agenda_result as $one_agenda_result) { ?>
                                                    <li>
                                                    <div class="img-holder mix other"style="height: 192px;">
                                                        <a href="<?php echo base_url("C_one_doc_opini/v_one_opini/" . $one_agenda_result->code_image . '-' . $one_agenda_result->id_docagenda) ?>">
                                                        <img src="<?php echo base_url('uploads/' . $one_agenda_result->file_content)?>" class="diva" alt="blog post">
                                                        </a>
                                                        <div class="img-hover text-center"style="width: 260px;height: 255px;">
                                                            <a href="<?php echo base_url("C_one_doc_opini/v_one_opini/" . $one_agenda_result->code_image . '-' . $one_agenda_result->id_docagenda) ?>">
                                                            <div class="img-hover-content">
                                                                <h5><?php echo $one_agenda_result->judul ?></h5>
                                                            </div>
                                                            </a>
                                                        </div>
