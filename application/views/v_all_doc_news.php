        ...
        <div id="content">
            ...
            <section class="portfolio portfolio-4-columns white-bg">
                ...
                <div class="projects relative ovh ">
                    <div class="projects relative ovh">
                        <?php foreach ($all_doc_news as $doc_news ) { ?>
                                <div class="img-holder mix other"style="width: 315px;height: 205px;">
                                    <!-- col-md-3 start here -->
                                    <div class="">
                                        <div class="gallery">
                                        <img src="<?php echo base_url('uploads/' . $doc_news->file_content)?>" alt="blog post">
                                        </div>
                                    </div>
                                    <div class="img-hover text-center"style="width: 315px;height: 205px;">
                                        <a href="<?php echo base_url("C_one_doc_news/v_one_news/" . $doc_news->code_image . '-' . $doc_news->id_docnews) ?>">
                                            <div class="img-hover-content">
                                            <p>
                                                <h5><?php echo $doc_news->judul ?></h5></p>
