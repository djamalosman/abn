...
<?php echo $this->session->flashdata('message'); ?>
        ...
        <div class="login-form">    
                ...
                <h4 class="modal-title"></h4>
                 ...
                 <br>
                    <a href="#" div class="form-group btn btn-primary btn-block btn-lg"  data-toggle="modal" data-target="#mySmallModal"style="color:white";><strong><h5>Update Password</h5></strong></div></a>       
          
            	<form action="<?php echo base_url("menu/date_expyre") ?>" method="post">
                   <div class="modal fade" id="mySmallModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="mySmallModalLabel">Expiry Date</h4>
                                </div>
                      ...
                      <div class="row clearfix">
                        ...
                        <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="username" readonly="" value="<?php echo $expyredate->f_userid  ?>" id="username"  class="form-control"  autocomplete="off" required="" placeholder="Username">
                                </div>
                            </div>
                        </div>
                    </div>
                     <div class="row clearfix">
                        ...
                        <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input autocomplete="off"  onblur="this.setAttribute('readonly', true);" type="password" name="password" class="form-control" placeholder="Password" required="required">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input value="<?php echo $expyredate->f_email ?>" autocomplete="off" readonly=""  onblur="this.setAttribute('readonly', true);" type="email" name="email"  class="form-control" placeholder="Email" required="required">
                                </div>
                            </div>
                        </div>
                    </div>
