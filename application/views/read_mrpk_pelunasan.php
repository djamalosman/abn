        ...
        <div class="col-lg-12">
            <div class="panel panel-danger toggle panelMove panelClose panelRefresh">
                ...
                <div class="panel-body">
                    <form name="myform" action="<?php echo base_url('Create_document/mrpk_pelunasan_view_create')?>"
                        ...
                        <div class=" form-group">
                            ...
                            <?php $arrax = array(); ?>
                            <?php foreach ($searchmrpk_pelunasan as $value) { $arrax[] = $value->NomorNasabah . '-' . $value->NamaDebitur;} ?>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12">
                                <table id="example"
                                    ...
                                    <?php foreach ($read_mrpkViewpelunasan as $item) { ?>
                                    <tr>
                                        <td>
                                            <a title="Delete"
                                                href="<?php echo base_url("Create_document/delete_deb_mrpk_pelunasan/".$item->cif) ?>"><i
                                                    class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            <a title="Edit"
                                                href="<?php echo base_url("Create_document/mrpk_pelunasan_view_edit/".$item->cif.'-'.$item->id_pelunasan) ?>"><i
                                            ...
                                            <a title="preview"
                                                href="<?php echo base_url("LaporanPdf/pelunasan/".$item->cif.'-'.$item->id_pelunasan) ?>"
