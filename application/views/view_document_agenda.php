            ...
            <div class="panel panel-danger toggle panelMove panelClose panelRefresh">
                ...
                <div class="panel-body">
                        ...
                        <div class=" form-group">
                            ...
                            <button class="btn" style="background-color: #1f3983;"><a href="<?php echo base_url('create_agenda')?>">Create</a></button>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <table id="example"
                                        ...
                                        <?php foreach ($doc_agenda as $item) { ?>
                                        <tr>
                                            <td>
                                                <a title="Delete"
                                                    href="<?php echo base_url("Create_document_agenda/delete_agenda/" . $item->code_image . '-' . $item->id_docagenda) ?>"><i
                                                        class="fa fa-trash-o" style="color: #1f3983;" aria-hidden="true"></i></a>
														<input value="" name="" type="hidden"/>
                                                <a title="Edit"
                                                    href="<?php echo base_url("Create_document_agenda/view_edit_agenda/" . $item->code_image . '-' . $item->id_docagenda) ?>"><i
                                                        class="fa fa-pencil" style="color: #1f3983;" aria-hidden="true"></i></a>
                                                <!-- <a title="preview"
                                                    href="<?php echo base_url("LaporanPdf/index/" . $item->code_image . '-' . $item->id_docagenda) ?>"
