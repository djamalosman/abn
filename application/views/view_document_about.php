            ...
            <div class="panel panel-danger toggle panelMove panelClose panelRefresh">
                ...
                <div class="panel-body">
                        ...
                        <div class=" form-group">
                            ...
                            <button class="btn" style="background-color: #1f3983;"><a href="<?php echo base_url('create_about')?>">Create</a></button>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <table id="example"
                                        ...
                                        <?php foreach ($doc_about as $item) { ?>
                                        <tr>
                                            <td>
                                                <a title="Delete"
                                                    href="<?php echo base_url("Create_document_about/delete_about/" . $item->code_image . '-' . $item->id_docabout) ?>"><i
                                                        class="fa fa-trash-o"  style="color:#1f3983;" aria-hidden="true"></i></a>
														<input value="" name="" type="hidden"/>
                                                <a title="Edit"
                                                    href="<?php echo base_url("Create_document_about/view_edit_about/" . $item->code_image . '-' . $item->id_docabout) ?>"><i
                                                        class="fa fa-pencil"  style="color: #1f3983;" aria-hidden="true"></i></a>
                                                <!-- <a title="preview"
                                                    href="<?php echo base_url("LaporanPdf/index/" . $item->code_image . '-' . $item->id_docabout) ?>"
