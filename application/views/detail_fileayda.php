            ...
            <div class="col-lg-12 col-md-4 col-sm-12">
                <div  class="panel panel-danger toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-heading" style="background-color: red;">
                        <h4 class="panel-title"><i class="glyphicon glyphicon-list-alt"></i>Dokumen Ayda</h4>
                    </div>
                    <div class="panel-body">
                        <div class="row profile">
                            ...
                            <div class="panel-body">
                                <form action="<?php echo base_url('ayda/updateImagedelete'); ?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                ...
                                                                <input type="checkbox" name="idnya[]" id="idnya[]" title="delete" value="<?php echo $file->file_content ?>" />
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                          ...
                                          <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group" hidden="">
                                                    <div class="form-line">
                                                        <input type="text" name="nomor_nasabah" id="nomor_nasabah" class="form-control" value="<?php echo $dataimage->f_cif ?>" placeholder="nomor_nasabah" required="">
                                                    </div>
                                                    <div class="form-line">
                                                        <input type="text" name="codein" id="codein" class="form-control" value="<?php echo $dataimage->code_in ?>" placeholder="nomor_nasabah" required="">
                                                    </div>
                                                </div>
                                            </div>
                                          </div>
