...
<html lang="en">
    ...
    <!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
        <head>
            ...
            <!--<base href="http://localhost/dashboard-master" target="_blank">-->
            <title>KSP Koperasi Sahabat Sampoerna</title>
            ...
            <aside id="left-panel" class="left-panel">
                <nav class="navbar navbar-expand-sm navbar-default">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href=""><img style="background: white; "width="100%" src="<?php echo base_url("template/images/logo.png") ?>" alt="Logo"></a>
                        <a class="navbar-brand hidden" href=""><img src="<?php echo base_url("template/images/shortcut-icon.png") ?>" alt="Logo"></a>
                    </div>
                ...
                <header id="header" class="header">
                    <div class="header-menu">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div>
                                <span style="font-size: 15pt">KSP Koperasi Sahabat Sampoerna</span>
                            </div>
...
<!--                                <div class="dropdown for-message">
                        ...
                        <div class="col-sm-5">
                            <div class="user-area dropdown float-right">
                                ...
                                ?>
                                <span class="d-sm-none d-md-inline-block" ><?php echo $nama." | ".$levelname  ?></span>&nbsp;&nbsp;
                                <a href="menu/logout">
                                    <!--<img class="user-avatar rounded-circle" src="<?php echo base_url() ?>template/images/admin.jpg" alt="User Avatar">-->
