 ...
 <div class="page-content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 mx-auto">
            <form action="<?php echo base_url('content/create_mrpkdammy/')
                    ...
                    <div class="col-sm-11">
                        ...
                        <tr>
                            ...
                            <select name="upayapenagihan">
                                    <option><?php echo $pelunasanprint->upayadesk ?></option>
                                </select>
                            </td>
                            <td>

                                <select name="collectioncabang">
                                    <option><?php echo $pelunasanprint->upayapihak ?></option>
                                </select>
                            </td>
               ...
               <div class="form-group row">
                    <div class="col-sm-11">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php {
                                if (!empty($pelunasanprint->pengumuman_tidak='' && $pelunasanprint->pengumuman_tidak='tidak')) {
                                     echo "<i class='fa fa-check ' aria-hidden='true' title='Approve'></i>";
                                }
                                } ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php {
                                if (!empty($pelunasanprint->lainya_ada = 'ada')) {
                                    echo "<i class='fa fa-check ' aria-hidden='true' title='Approve'></i>";
                                }
                                }?>
                            </td>
                            <td>
                                <?php {
                                if (!empty($pelunasanprint->lainya_tidak =='tidak')) {
                                     echo "<i class='fa fa-check ' aria-hidden='true' title='Approve'></i>";
                                }
                                } ?>
                            </td>
...
<?php echo $pelunasanprint->rekomen_kredit ?>
                ...
                <a href="<?php echo base_url ('content/read_mrpk')?>" button type="submit" class="btn btn-primary px-4 float-right">cancel</button></a>
                <!-- <a href="<?php //echo base_url ('content/printPDFmrpkPelunasan/'.$datadammy->f_cif)?>" button type="submit" class="btn btn-primary px-4 float-right">tesPrint</button></a> -->
