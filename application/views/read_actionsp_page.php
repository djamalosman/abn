            ...
            <div class="col-lg-12">
                <div class="panel panel-danger toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo base_url('Spesial_stage/update_insert_specialstage'); ?>" enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label class="col-lg-3 control-label" for="cif">Cif</label>
                                    <div class="col-lg-6">
                                        <input style=" height: 30px;" type="number" readonly="" class="form-control" id="cif" value="<?php echo $inputsepcialstage->NomorNasabah ?>" name="cif">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="col-lg-3 control-label" for="nama">Nomor Rekening</label>
                                    <div class="col-lg-6">
                                        <input id="loanid" readonly="" value="<?php echo $inputsepcialstage->NomorRekening ?>" name="NomorRekening" style=" height: 30px" type="text" class="form-control" required="">
                                ...
                                <div class="col-lg-6" hidden="">
                                    ...
                                    <div class="col-lg-6">
                                        <input id="loanid" readonly="" value="<?php echo $inputsepcialstage->NamaDebitur ?>" name="NamaDebitur" style=" height: 30px" type="text" class="form-control" required="">
                                        <?php echo form_error('f_empname', "<span style='font-size: 10pt; color: red'>", "</span>") ?>
                                    </div>
                                </div>
                                <div class="col-lg-6"hidden="">
                                    ...
                                    <div class="col-lg-6">
                                        <input id="loanid" readonly="" value="<?php echo $inputsepcialstage->LD_Temenos ?>" name="LD_Temenos" style=" height: 30px" type="text" class="form-control" required="">
                                        <?php echo form_error('f_empname', "<span style='font-size: 10pt; color: red'>", "</span>") ?>
                                    </div>
                                </div>
                                <div class="col-lg-6"hidden="">
                                    ...
                                    <div class="col-lg-6">
                                        <input id="loanid" readonly="" value="<?php echo $inputsepcialstage->nama_cabang ?>" name="nama_cabang" style=" height: 30px" type="text" class="form-control" required="">
                                        <?php echo form_error('f_empname', "<span style='font-size: 10pt; color: red'>", "</span>") ?>
                                    </div>
                                </div>
                                <div class="col-lg-6"hidden="">
                                    ...
                                    <div class="col-lg-6">
                                        <input id="loanid" readonly="" value="<?php echo $inputsepcialstage->KodeCabang ?>" name="KodeCabang" style=" height: 30px" type="text" class="form-control" required="">
                                        <?php echo form_error('f_empname', "<span style='font-size: 10pt; color: red'>", "</span>") ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <?php echo form_error('f_compid', "<span style='font-size: 10pt; color: red'>", "</span>") ?> <select class="form-control show-tick" name="f_flagspecialstage" id="f_flagspecialstage" data-live-search="true" required="">
                                            ...
                                            foreach ($paramstage as $row) : ?>
                                                <?php echo '<option value="' . $row->f_type . '-' . $row->f_desc . '">' . $row->f_desc . '</option>'; ?>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6" style="margin-bottom:20px;">
                                        <input type="file" name="userfile" size="20" required="true" accept="image/*,application/pdf" />
                                    </div>
                                </div>
                            </div>
