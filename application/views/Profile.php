...
<body>
  ...
  <main>
    <p class="animasi"><b>Pofile</b></p>
    <hr />
    <div>
    <img src="<?php echo base_url('uploads/' . $profile->file_content)?>" alt="Gambar" class="img-detilberita">
    </div>
    <div id="liputan"></div>
...
<!-- end share -->
    ...
    <p class="liputan1"><?php echo $profile->nama_asli ?></p>
    <hr />
    <div  class= "p-berita">
