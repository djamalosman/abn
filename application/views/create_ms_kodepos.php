<html>
    <body>
            <div class="container-fluid">
                ...
                <?php echo form_open('content/create_ms_kodepos_process', 'id="swaz-confirm"'); ?>
                <div class="form-group" >
                    <label for="f_postcode">Kode Pos</label>
                    <input type="text" class="form-control" id="f_postcode" name="f_postcode">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" class="form-control" id="f_notes" name="f_notes">
