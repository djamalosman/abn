    ...
    <div class="panel panel-success ">
        <div class="row">
            <div class="col-md-12 mx-auto">
                <form action="<?php echo base_url('Create_document_about/create_doc_about') ?>"method="POST" enctype="multipart/form-data">            
                ...
                <div class="form-group row">
                        ...
                        <div class="panel-heading" style="background-color:#1f3983">
                            <h4 class="panel-title "style="color:white"><i class="glyphicon glyphicon-headphones"style="color:white";></i>Insert Data About</h4>
                        </div>
                          <div class="col-sm-11">
                                <br>
                    ...
                    <a href="<?php echo base_url ('news')?>" button type="submit" class="btn btn-primary px-4 float-right">Cancel</button></a>
