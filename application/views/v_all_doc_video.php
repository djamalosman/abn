                        ...
                        <div class="row">
                            <div id="" class="col-lg-10">
                                <div class="row gallery sortable-layout">
                                    ...
                                    <!-- End .col-md-3 -->
                                <?php foreach ($all_doc_video as $video_all){?>    
                                    <div class="col-xs-12 col-md-3" >
                                        ...
                                        <div class="panel panel-default plain panelMove">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <a href="<?php echo $video_all->link_video ?>" data-toggle="lightbox" data-gallery="gallerymode" data-title="Yachts" data-parrent>
                                                <!-- <iframe class="video-responsive" allowfullscreen="" frameborder="0"  src="https://www.youtube.com/embed/OGzZ0CKUilE" ></iframe> -->
                                                    <iframe class="video-responsive" autoPlay=false" src="<?php echo $video_all->link_video ?>"allowfullscreen="" frameborder="0"style="width:354px;height:200px"></iframe>
                                                <h6 style="color:blue;"><?php echo $video_all->judul ?></h6>   
                                                </a>
                                            </div>
                                        </div>
                                        <!-- End .panel -->
