            ...
            <section class="white-bg blog-item">
                <div class="container">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="blog-post">
                            <!-- Start .blogpost -->
                            <h2 class="blog-post-title"><?php echo $v_one_staff->nama_asli ?></h2>
                            <div class="blog-meta">
                                <span class="date">
                        <a href="#">
                            <i class="fa fa-calendar"></i>
                            <?php echo $v_one_staff->tanggal_insert ?>
                        </a>
                    </span>
                        ...
                        <a href="#">
                            ...
                            <div class="img-holder">
                                <a href="#l">
                                    <div class="bg-img-holder">
                                        <img src="<?php echo base_url('uploads/' . $v_one_staff->file_content)?>" alt="blog post">
                                    </div>
                                </a>
                            </div>
                            <div class="blog-post-content">
                                <p>
                                    ...
                                    <?php echo $v_one_staff->description ?>
                                </p>
                                <!-- / .row -->
                            </div>
                        </div>
                            ...
                            <div class="tabs simple-tabs">
                                ...
                                <div id="rstab-content" class="tab-content">
                                    <div class="tab-pane fade active in" id="popular-posts">
                                            ...
                                            <?php foreach($v_one_staff_result as $one_staff_result) { ?>
                                                    <li>
                                                    <div class="img-holder mix other"style="height: 275px;">
                                                        <a href="<?php echo base_url("C_one_doc_news/v_one_news/" . $one_staff_result->code_image . '-' . $one_staff_result->id_docstaff) ?>">
                                                        <img src="<?php echo base_url('uploads/' . $one_staff_result->file_content)?>" class="diva" alt="blog post">
                                                        </a>
                                                        <div class="img-hover text-center"style="width: 260px;height: 255px;">
                                                            <a href="<?php echo base_url("C_one_doc_news/v_one_news/" . $one_staff_result->code_image . '-' . $one_staff_result->id_docstaff) ?>">
                                                            <div class="img-hover-content">
                                                                <h5><?php echo $one_staff_result->jabatan ?></h5>
                                                            </div>
                                                            </a>
                                                        </div>
