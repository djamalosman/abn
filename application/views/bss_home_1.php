...
<!--        <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css"  />
        ...
        <!--<script src="<?php echo base_url('bst/jquery.js') ?>"></script>-->
        <!--<script src="<?php echo base_url('bst/DataTables/js/jquery.dataTables.js') ?>"></script>-->
        <!--<link href="<?php echo base_url('bst/DataTables/css/jquery.dataTables.css') ?>" rel="stylesheet" type="text/css"/>-->
        <!--<link href="<?php echo base_url('bst/DataTables/css/dataTables.bootstrap.css') ?>" rel="stylesheet" type="text/css"/>-->
        ...
        <div id="header" class="page-navbar">
            ...
            <div id="navbar-no-collapse" class="navbar-no-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#"><span style="font-size: 20px;" class="text">BSS - Bank Sahabat Sampoerna</span> </a>
                    </li>
                    ...
                    <div class="page-content-inner">
                        ...
                        <div id="page-header" class="clearfix">
                            <div class="page-header">
                                <h2 style=" font-style: ">C24System</h2>
                                <span class="txt">Collection System</span>
                            </div>
                            <div class="header-stats">
                                ...
                                <li>
                                    ...
                                    // $appflag = $this->session->userdata('appflag');
                                    ?>
                                    <a href="#"><span style="font-size: 20px;" class="text"><?php echo isset($pagename) ? $pagename : "" ?></span></a>
                                </li>
