                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="name_nasabah" class="form-control" name="name_nasabah" value="<?php echo $debitur->f_nama_nasabah ?>" readonly="" placeholder="Nama Nasabah">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <?php foreach ($foto as $key) {
                                echo '
                                   ...
                                   <table id="responsive"  class="table nowrap table-bordered" style="width:100%;border: 2px;">
                                    ...
                                    <tr> 
                                    <th>   
                                    <img  id="myImg" src="data:image/png;base64,'.base64_encode($key->f_file_content).'" width="100%" height="40%"/>
                                    <br><label>'.$key->f_keterangan.'</label>
                                    </th>
                                    </tr>
                                    </thead>
                                </table>
