...
<html class="no-js">
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 768px) {
           ...
           .figure-meta {
            margin: 26em 0em 0em 0em !important;
    ...
    <![endif]-->
        <div id="header" class="header-fixed">
            ...
            <div class="container">
                ...
                <a href="/" class="logo">
                    ...
                    <img style="height: 7em; width: auto;" src="<?php echo base_url('assets/frontend/img/abn.png')?>" alt="Dynamic Frontend logo">
                </a>
        ...
        <div id="content">
            ...
            <section class="portfolio portfolio-4-columns white-bg">
                ...
                <!-- / .container -->
                <div class="projects relative ovh" id="m-tokoh" style="width: 100%;margin: 0em 4em;display: flex;flex-direction: row;justify-content: space-evenly;">
                <?php foreach ($all_doc_tokoh as $tokoh_all){?>    
                            <div class="img-holder mix other" >
                                <!-- col-md-3 start here -->
                                <div class="bg-img-holder"style="border-radius: 50% !important;width: 325px;height: 325px;">
                                    <img src="<?php echo base_url('uploads/' .  $tokoh_all->file_content)?>" alt="blog post">
                                </div>
                                <div class="figure-meta">   
                                <h5 style="font-weight: 600;"><?php echo $tokoh_all->jabatan ?></h5>
                                <p><a href="<?php echo base_url("C_one_doc_tokoh/v_one_tokoh/" . $tokoh_all->code_image . '-' . $tokoh_all->id_doctokoh) ?>"><?php echo $tokoh_all->nama_asli ?></a></p>
                                </div>
                            </div>
                    <?php } ?>
                </div>
