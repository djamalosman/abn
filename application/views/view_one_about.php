                ...
                <div class="container">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="blog-post">
                            ...
                            <?php
                             if($all_doc_about==null){
                                echo '';
                             }else{
                              echo  $all_doc_about->judul;
                             }
                             ?>
                             </h2>
                            <div class="blog-meta">
                        ...
                        <a href="#">
                            ...
                            <?php
                             if($all_doc_about==null){
                               ...
                               echo  $all_doc_about->tanggal_insert;
                             }
                             ?>
                                ...
                                <a href="#l">
                                    <div class="bg-img-holder">
                                        ...
                                        echo'';
                                            ...
                                            echo base_url('uploads/' . $all_doc_about->file_content);
                                        }
                                         ?>" alt="blog post">
                                    </div>
                                </a>
                            ...
                            <div class="blog-post-content">
                                ...
                                <?php
                                 if($all_doc_about==null){
                                   ...
                                   echo  $all_doc_about->description;
                                 }
                                 ?>
                                </p>
                                <!-- / .row -->
                                ...
                                <div id="rstab-content" class="tab-content">
                                    <div class="tab-pane fade active in" id="popular-posts">
                                            <ul class="blog-list-small">
                                                    ...
                                                    <li>
                                                        <a href="<?php if($all_doc_about==null){
                                                            echo'';
                                                        }else{
                                                         echo base_url("Create_document_about/v_all_one_about/" . $all_doc_about->code_image . '-' . $all_doc_about->id_docabout); 
                                                        }
                                                         ?>">
                                                        <img src="<?php if($all_doc_about==null){
                                                            echo'';
                                                            }else{
                                                                echo base_url('uploads/' . $all_doc_about->file_content);
                                                            
                                                            }
                                                            ?>" class="diva" alt="blog post">
                                                        </a>
                                                        <h4>
                                                        
                                                            <a href="<?php echo base_url("Create_document_about/v_all_one_about/" . $all_doc_about->code_image . '-' . $all_doc_about->id_docabout) ?>"><h6><?php echo $all_doc_about->judul ?></h6></a>
