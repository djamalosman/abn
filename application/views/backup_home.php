    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><img src="<?php echo base_url("template/images/logo.png") ?>" alt="Logo"></a>
                <a class="navbar-brand hidden" href=""><img src="<?php echo base_url("template/images/logo2.png") ?>" alt="Logo"></a>
            </div>
           ...
           <div class="col-xl-3 col-lg-6">
                <section class="card">
                    <div class="twt-feed blue-bg">
                        ...
                        <div class="media">
                            <a href="#">
                                <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="<?php echo base_url() ?>template/images/admin.jpg">
                            </a>
