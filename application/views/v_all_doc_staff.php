    ...
    <![endif]-->
        ...
        <div id="content">
            ...
            <section class="portfolio portfolio-4-columns white-bg">
                ...
                <?php foreach ($all_doc_staff as $taff_all){?>    
                            <div class="img-holder mix other">
                                <!-- col-md-3 start here -->
                                <div class="bg-img-holder"style="border-radius: 50% !important;width: 325px;height: 325px;">
                                    <img src="<?php echo base_url('uploads/' .  $taff_all->file_content)?>" alt="blog post">
                                </div>
                                <div class="img-hover text-center"style="border-radius: 50% !important;width: 325px;height: 325px;">
                                    <a href="<?php echo base_url("C_one_doc_staff/v_one_staff/" . $taff_all->code_image . '-' . $taff_all->id_docstaff) ?>">
                                        <div class="img-hover-content">
                                            <h5><?php echo $taff_all->jabatan ?></h5>
                                            <p><?php echo $taff_all->nama_asli ?></p>
