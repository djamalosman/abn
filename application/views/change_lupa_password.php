...
<?php echo $this->session->flashdata('message'); ?>
        ...
        <div class="login-form">    
            	...
            	<form action="<?php echo base_url("menu/passwordchange_lupa") ?>" method="post">
                   <div class="modal fade" id="mySmallModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input value="<?php echo $ceklupassword->f_email ?>" autocomplete="off" readonly=""  onblur="this.setAttribute('readonly', true);" type="email" name="email"  class="form-control" placeholder="Email" required="required">
                                </div>
                            </div>
                        </div>
                    </div>
