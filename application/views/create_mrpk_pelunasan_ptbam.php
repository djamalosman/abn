<head>
   ...
   $(document).on("keyup", ".qty5", function() {
    ...
    //     if(!pokok1){pokok1 = 0;}
    //     if(!pokok2){pokok2 = 0;}
    //     var tlthpstgh1 = parseInt(pokok1) - parseInt(pokok2) - parseInt(hapustagih_a1);
    //     $('#tlthpstgh11').eq(i).val(tlthpstgh1);
    //     // hpstghtotal(i);
                ...
                <div class="container py-5">
                    <div class="row">
                        <div class="col-md-12 mx-auto">
                            <form
                                action="<?php echo base_url('Create_document/create_mrk_pelunasan_ptbam/').$pelunasan_ptbam->NomorNasabah ;?>"
                                method="POST">
                                <div id="printablediv">
                                    <div class="form-group row">
                                            ...
                                            <table id="printTable"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input value="<?php echo $pelunasan_ptbam->NamaDebitur ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input value="<?php echo $pelunasan_ptbam->ADDRESS ?>" name="alamat_debitur" type="text" style="width:100% ; border: 1;">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input value="<?php echo $pelunasan_ptbam->NomorNasabah ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input value="<?php echo $pelunasan_ptbam->EMPLOYERS_ADD ?>" name="lokasi_usaha" type="text" style="width:100% ; border: 1;">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input
                                                                value="<?php echo date("d-m-Y", strtotime($pelunasan_ptbam->STARTDATEPLAFOND)); ?>" " name="
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input value="<?php echo $pelunasan_ptbam->JmlHariTunggakan ?> " name="dpd" type="text" style="width:100% ; border: 1;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input value="<?php echo $pelunasan_ptbam->COL ?>" name="kolektibilitas" type="text" style="width:100% ; border: 1;">
                                        ...
                                        <div class="col-sm-11">
                                            ...
                                            <table class="tablex table-bordered table-striped table-hover" id="table2">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                         $_idx_loop = 1;
                                                         $_data_length = count($pelunasan_ptbam_result);
                                                         $totalPlafond = 0;
                                                         $totalA = 0;
                                                         $totalB = 0;
                                                         $totalC = 0;
                                                         $totalD = 0;
                                                     ?>
                                                    <?php foreach ($pelunasan_ptbam_result as $value) { 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="qty4"
                                                                value="<?php echo number_format($value->DueBunga,2,'','') ?>"name="tunggakan_bunga[]"
                                                                style="border: 0;background-color: transparent;width:100%">
                                                        ...
                                                        <td>
                                                            <input class="qty5"
                                                                value="<?php echo number_format($value->DUE_CH ,2,'','')?>"name="tunggakan_denda[]"
                                                                style="border: 0;background-color: transparent;width:100%">
                                        ...
                                        <div class="col-sm-11">
                                            ...
                                            <table class="tablex table-bordered table-striped table-hover" id="table2">
                                                ...
                                                <tbody>
                                                    <?php $_idx_loop = 1; $_data_length = count($pelunasan_ptbam_result);
                                                          $totalPlafond = 0;
                                                          $totalA1 = 0;
                                                          $totalB1 = 0;
                                                          $totalC1 = 0;
                                                          $totalD1 =0;                                    
                                                    ?>
                                                    <?php foreach ($pelunasan_ptbam_result as $key) { 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="qty7"
                                                                value="<?php echo  number_format($key->EXECUTION_VALUE,2,'','')  ?>"name="mv_lama[]"
                                                                style="width:100%!important;background-color: transparent; border: 0;">
                                                        </td>
                                                        <td>
                                                            <input class="qty8"
                                                                value="<?php echo  number_format($key->NOMINAL_VALUE ,2,'','') ?>"name="lv_lama[]"
                                                                style="width:100%!important;background-color: transparent; border: 0;">

                                                        </td>
                                                        <td>
                                                            <input class="qty9" value="<?php echo number_format($key->NOMINAL_VALUE ,2,'','') ?>"name="mv_baru[]"
                                                                style="width:100%!important;background-color: transparent; border: 0;">

                                                        </td>
                                                        <td>
                                                            <input class="qty10" value="<?php echo number_format($key->NOMINAL_VALUE ,2,'','') ?>"name="lv_baru[]"
                                                                style="width:100%!important;background-color: transparent; border: 0;">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input class="total7" value="<?php   echo   $totalA1   ?>"name="total_mv_lama"
                                                                style="border: 0;background-color: transparent;width:100%">
                                                        </td>
                                                        <td><input class="total8" value="<?php  echo   $totalB1   ?>"name="total_lv_lama"
                                                                style="border: 0;background-color: transparent;width:100%">
                                                        </td>
                                                        <td><input class="total9" value="<?php  echo   $totalC1   ?>"name="total_mv_baru"
                                                                style="border: 0;background-color: transparent;width:100%">
                                                        </td>
                                                        <td><input class="total10" value="<?php echo   $totalD1   ?>"name="total_lv_baru"
                                                                style="border: 0;background-color: transparent;width:100%">
                                                        </td>
                                                        <td><?php echo ''; ?></td>
                                                    </tr>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-11">
                                            ...
                                            <table class="tablex table-bordered table-striped table-hover" id="table2">
                                                ...
                                                <tbody>
                                                    <?php $_idx_loop = 1; $_data_length = count($pelunasan_ptbam_result); ?>
                                                    <?php if(!empty($pelunasan_ptbam_result)){ ?>
                                                    <?php $fs_idx = 0; ?>
                                                    <?php
                                                    $i = 0;
                                                    foreach ($pelunasan_ptbam_result  as $value) { ?>
                                                    <tr>
                                ...
                                <a href="<?php echo base_url ('create_document/read_mrpk_pelunasan_ptbam')?>" button
