 ...
 <div class="page-content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 mx-auto">
            <form action="<?php echo base_url('create_document/create_pelunasan_mrpk/').$pelunasan_row->NomorNasabah ;?>" method="POST">
            <div id="printablediv">
               <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-11">
                        ...
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
                            <td><input value="<?php echo $pelunasan_row->NAME_1 ?>" name="name" autocomplete="off"   style="border:1px; background-color:white;width: 75%;"></td>
                            <tr>
                                <td>Alamat</td>
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $pelunasan_row->ADDRESS ?>" name="alamat" autocomplete="off"   style="border:1px; background-color:white;width: 75%;">
                             ...
                             <tr>
                                ...
                                <td>:</td>
                                <td>
                                 <input value="<?php echo $pelunasan_row->NomorNasabah ?>" name="cif" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo '' ?>" name="bidang_usaha" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $pelunasan_row->ADDRESS ?>" name="lokasi_usaha" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo'' ?> "name="nama_group_usaha" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo '' ?>" name="debitur_sejak" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo '' ?>" name="menunggak_sejak" autocomplete="off" style="border:1px; background-color:white;width: 75%;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo $pelunasan_row->JmlHariTunggakan ?>" name="dpd" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input  name="col" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                                </td>
                            </tr>
                            <tr>
                                <td>CKPN</td>
                                <td>:</td>
                                <td>
                                     <input  name="ckpn" autocomplete="off"  style="border:1px; background-color:white;width: 75%;">
                                </td>
                            </tr>
                        </tr>
                        </tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td hidden>
                                                            ...
                                                            <input value="<?php echo $value->NomorRekening ?>"
                                                                name="norek[]"
                                                                style="border: 0;background-color: white;width:100%">
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input class="qty"
                                                                ...
                                                                style="width:110px!important; border: 0;background-color: white">
                                                        </td>
                                                        <td>
                                                            <input class="qty2"
                                                                value="<?php echo number_format($value->BakiDebet,2,'','')  ?>"
                                                                name="os_per[]"
                                                                style="border: 0;background-color: white;width:100%">
                                                        ...
                                                        <td>
                                                            ...
                                                            <input class="qty3" value="<?php echo $value->selisih ?>"
                                            ...
                                            <table class="tablex table-bordered table-striped table-hover" id="table2">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($pelunasan_result as $key) { 
                                                           ...
                                                           $totalC1= $totalC1 + $key->EXECUTION_VALUE; 
                                                           $totalD1=$totalD1 + $key->NOMINAL_VALUE; //+ $key->DUE_CH;   
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $_idx_loop; ?></td>
                                                        <td>
                                                            <textarea name="tipe_jaminan_agunan[]" cols="5" rows="8" style="width:100%"></textarea>
                                                        </td>
                                                        <td>
                                                            <textarea name="desc_agunan[]"  cols="5" rows="8"style="width:100%"></textarea>
                                                        </td>
                                                        <td>
                                                            <input class="qty7"value="<?php echo number_format($key->EXECUTION_VALUE,2,'','')   ?>"name="mv_lama[]"
                                                                style="width:100%!important;background-color: white; border: 0;">
                                                        </td>
                                                        <td>
                                                            <input class="qty81"
                                                        ...
                                                        <td>
                                                            <input class="qty82" value="<?php echo ''; ?>"
                                                                name="mv_baru[]"
                                                                style="width:100%!important;background-color: white; border: 0;">

                                                        </td>
                                                        <td>
                                                            <input class="qty83" value="<?php echo ''; ?>"
                                                                name="lv_baru[]"
                                                                style="width:100%!important;background-color: white; border: 0;">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input class="total81" value="<?php  echo   $totalB1   ?>"
                                                                name="total_lv_lama"
                                                                style="border: 0;background-color: white;width:100%">
                                                        </td>
                                                        <td><input class="total82" value="<?php  echo   $totalC1   ?>"
                                                                name="total_mv_baru"
                                                                style="border: 0;background-color: white;width:100%">
                                                        </td>
                                                        <td><input class="total83" value="<?php echo   $totalD1   ?>"
                                                                name="total_lv_baru"
                                                                style="border: 0;background-color: white;width:100%">
                                                        </td>
                                                        <td><?php echo ''; ?></td>
                                        ...
                                        <div class="col-sm-11">
                                            ...
                                            <table class="tablex table-bordered table-striped table-hover" id="table2">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="7"><?php echo 'Fasilitas :',$value->ketfasilitas ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="" id="resultpersen1[<?php echo $i ?>]" name="persen_a1[]"style="width:100px!important; border: 1;">
                                                        </td>
                                                        <td>
                                                            <input class="pokok3" 
                                                        ...
                                                        <td>
                                                            <input class="" id="resultpersen2[<?php echo $i ?>]" name="persen_a2[]"style="width:100px!important; border: 1;">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class=""  id="resultpersen3[<?php echo $i ?>]" name="persen_a3[]"style="width:100%!important; border: 1;">
                                                        </td>
                                                        <td>
                                                            <input class="bunga3" 
                                                        ...
                                                        <td>
                                                            <input class="" id="resultpersen4[<?php echo $i ?>]" name="persen_a4[]"style="width:100%!important; border: 1;">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class=""  id="resultpersen5[<?php echo $i ?>]"name="persen_a5[]"style="width:100%!important; border: 1;">
                                                        </td>
                                                        <td>
                                                            <input class="denda3" 
                                                        ...
                                                        <td>
                                                            <input class=""  id="resultpersen6[<?php echo $i ?>]" name="persen_a6[]" style="width:100%!important; border: 1;">
                                                        </td>
                                                    </tr>
                                                    <?php $_idx_loop++; ?>
                                                    <tr>
                                                        <th colspan="1" align="center">Total</th>
                                                        <td><input  class="tlt1"name="tltkewajiban[<?php echo $i?>]" readonly="" id="ttlkewajiban[<?php echo $i?>]" data-index="<?php echo $fs_idx; ?>"></td>
                                                        <td><input  class="tlt2"name="ttldibayar[<?php echo $i?>]" readonly="" id="ttldibayar[<?php echo $i?>]"></td>
                                                        <td></td>
                                                        <td><input  class="ttlhpstgh"name="ttlsisakewajiban[<?php echo $i?>]"readonly="" id="ttlsisakewajiban[<?php echo $i?>]"></td>
                                                        <td><input  class="hpstghtotal"name="ttlsisahapustagih[<?php echo $i?>]"readonly="" id="ttlsisahapustagih[<?php echo $i?>]"></td>
                                                        <td></td>
                                                    </tr>
                                                    <?php $fs_idx++; ?>
                                                    <?php $i++;  }  ?>
                ...
                <div class="col-sm-11">
                    ...
                    <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote13">WYSIWYG made easy ...</div>
                    </div>
            ...
            <div class="col-sm-11">
                <table class="tablex table-bordered table-striped table-hover" id="table2">
                    <tbody>
                        <tr>
                            <tr>
                                    <td><input name="porsi_pokok" id="porsi_pokok" value="<?php echo 'Porsi Pokok' ?>"style="background-color:white;border:0px;"></td>
                                    <td>Rp</td>
                                    <td>
                                        <input value="<?php echo '' ?>"  class="porsipokok"  name="hsl_porsi_pokok" id="hsl_porsi_pokok" autocomplete="off"   style="border:1px; background-color:white;width: 75%;">  
                                    </td>
                                    
                            </tr>
                            <tr>
                                    <td><input name="total_dibayar" id="total_dibayar" value="<?php echo 'Total yang di bayarkan' ?>"style="background-color:white;border:0px;"></td>
                                    <td>Rp</td>
                                    <td>
                                        <input value="<?php echo '' ?>" class="ttldibayarkan"  name="hsl_dibayar" id="hsl_dibayar" autocomplete="off"   style="border:1px; background-color:white;width: 75%;">  
                                    </td>
                                    
                            </tr>
                            <tr>
                                    <td><input name="pengajuan_waive" id="pengajuan_waive" value="<?php echo 'pengajuan Waive Pokok (%)' ?>"style="background-color:white;border:0px;"></td>
                                    <td>Rp</td>
                                    <td>
                                        <input value="<?php echo '' ?>" readonly=""  class="qty66" name="hsl_pengajuan_waive" id="hsl_pengajuan_waive" autocomplete="off"   style="border:1px; background-color:white;width: 75%;">  
                                    </td>
                                    
                            </tr>
                            <tr>
                                    <td><input name="ckpn_per" id="ckpn_per" value="<?php echo 'CKPN per' ?>"style="background-color:white;border:0px;"></td>
                                    <td>Rp</td>
                                    <td>
                                        <input value="<?php echo '' ?>" class="ckpnper" name="hsl_ckpn_per" id="hsl_ckpn_per" autocomplete="off"   style="border:1px; background-color:white;width: 75%;">  
                                    </td>
                                    
                            </tr>
                            <tr>
                                    <td><input name="kekurangan_ckpn" id="kekurangan_ckpn" value="<?php echo 'Kekurangan CKPN' ?>"style="background-color:white;border:0px;"></td>
                                    <td>Rp</td>
                                    <td>
                                        <input value="<?php echo '' ?>" class="kekuranganckpn" name="hsl_kekurangan_ckpn" id="hsl_kekurangan_ckpn" autocomplete="off"   style="border:1px; background-color:white;width: 75%;">  
                                    </td>
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-11">
                    ...
                    <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote2">WYSIWYG made easy ...</div>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-11">
                       ...
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote5">WYSIWYG made easy ...</div>
                        </div>
                ...
                <div class="form-group">
                   <div class="col-sm-11">
                       ...
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote8">WYSIWYG made easy ...</div>
                        </div>
                ...
                <div class="col-sm-11">
                       ...
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote11">WYSIWYG made easy ...</div>
                        </div>
