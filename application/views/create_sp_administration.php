<html>
    <body>
            <div class="container-fluid">
                ...
                <?php echo form_open('content/create_sp_administration_process', 'id="swaz-confirm" class="form-horizontal"'); ?>
                <div class="row form-group">
                    <div class="col col-md-3">
                        <label for="f_jenisSp">Jenis SP</label>
                    </div>
                    <div class="col-12 col-md-9">
                        <input type="text" class="form-control" id="f_jenisSp" name="f_jenisSp">
                ...
                <div class="row form-group" >
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" class="form-control" id="f_produk" name="f_produk">
                ...
                <div class="row form-group" >
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" class="form-control" id="f_DPDmin" name="f_DPDmin">
                ...
                <div class="row form-group" >
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" class="form-control" id="f_masaBerlaku" name="f_masaBerlaku">
