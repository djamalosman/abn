...
<div class="row">
    <form id="action" action="<?php echo base_url('userweb/approveduserweb'); ?>" method="POST" class="form-horizontal group-border stripped"> 
        <?php // echo form_open("usermobile/approvedcollector", "id='swa-confirm'") ?>
        <div class="col-lg-12">
            <div class="panel panel-danger toggle panelMove panelClose panelRefresh">
                <div class="panel-heading" style="background-color: red">
                    <h4 class="panel-title"><i class="glyphicon glyphicon-check"></i>Approval User Web</h4>
                </div>
                <div class="panel-body">
                    ...
                    <button style="margin-left: 16px;" type="button" name="aproved" id="aproved" class="btn btn-primary btn-sm mr5 mb10" ><i class="fa fa-pencil-square-o"></i>  <span class="text"> Approve</span></button>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table  id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php foreach ($approveuserweb as $item) { ?>
                                    <tr>     

                                        <td class="text-center" >

                                            <input type="checkbox" value="<?php echo $item->f_userid ?>" name="idnya[]"/>
                                        </td>
                                        <td><button  data-toggle="modal" data-target="#modals2" data-id ="<?php echo $item->f_userid ?>" style="background-color: red" style="margin-left: 16px;" type="button" name="reject" id="reject1" class="btn btn-danger btn-xs mr5 mb10" ><i class="glyphicon glyphicon-remove"></i>  <span class="text"> Reject</span></button></td>
...
<div  class="modal fade" id="modals2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-center">
        <form action=" <?php echo base_url('userweb/reject_aprove'); ?>" method="post">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#aproved').click(function () {
            $('#action').attr('action', '<?php echo base_url('userweb/approveduserweb'); ?>');
            $('#action').submit();
        });

        $('#reject').click(function () {
            $('#action').attr('action', '<?php echo base_url('userweb/reject_aprove'); ?>');
            $('#action').submit();
        });
