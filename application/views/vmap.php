                ...
                <div class="panel-body">
                        ...
                        <div class=" form-group">
                                ...
                                <div class="btn-group mr10 mb10 col-lg-3">
                                    <button class="btn" style="background-color: #1f3983;"><a href="<?php echo base_url('mapcreate')?>">Create</a></button>
                                </div>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <table id="example"
                                        ...
                                        <tr>
                                            <td>
                                            <a title="Delete"
                                                    href="<?php echo base_url("map/mapdelete/" . $item->idmap) ?>"><i
                                                        class="fa fa-trash-o"  style="color:#1f3983;" aria-hidden="true"></i></a>
														<input value="" name="" type="hidden"/>
                                                <a title="Edit"
                                                    href="<?php echo base_url("map/editmap/" . $item->idmap) ?>"><i
