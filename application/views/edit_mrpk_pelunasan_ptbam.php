 ...
 <div class="page-content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 mx-auto">
            <form action="<?php echo base_url('Create_Document/update_mrk_pelunasan_ptbam/').$getdata_ptbam_row->cif.'-'.$getdata_ptbam_row->id_pt_bam ;?>" method="POST">
            <div id="printablediv">
                <div class="form-group row">
                     <div class="col-sm-11">
                        <label for="inputState">Jenis Pengajuan</label>
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote1"><?php echo $getdata_ptbam_row->jenis_pengajuan ?></div>
                        </div>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input value="<?php echo $getdata_ptbam_row->nama_debitur ?>" name="nama_debitur"
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $getdata_ptbam_row->alamat_debitur ?>" name="alamat_debitur"  
                                       type="text" style="width:100% ; border: 1;">
                             ...
                             <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $getdata_ptbam_row->cif ?>" name="cif" readonly=""  
                                       type="text" style="width:100% ; border: 1;">
                               </td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo $getdata_ptbam_row->bidang_usaha ?>"name="bidang_usaha"  
                                       type="text" style="width:100% ; border: 1;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $getdata_ptbam_row->lokasi_usaha ?>" name="lokasi_usaha"  
                                      type="text" style="width:100% ; border: 1;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo $getdata_ptbam_row->nama_group_usaha ?>" name="nama_group_usaha"  
                                       type="text" style="width:100% ; border: 1;">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $getdata_ptbam_row->debitur_sejak ?>" name="debitur_sejak"  
                                       type="text" style="width:100% ; border: 1;">
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $getdata_ptbam_row->menunggak_sejak ?>" name="menunggak_sejak"  
                                       type="text" style="width:100% ; border: 1;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo $getdata_ptbam_row->dpd ?>" name="dpd"  
                                       type="text" style="width:100% ; border: 1;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                     <input value="<?php echo $getdata_ptbam_row->kolektibilitas ?>" name="kolektibilitas"  
                                       type="text" style="width:100% ; border: 1;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input value="<?php echo $getdata_ptbam_row->ckpn ?>"
                                     name="ckpn"  
                                       type="text" style="width:100% ; border: 1;">
                                    </td>
                            </tr>
   ...
   <tbody>
    ...
    <?php
        $_idx_loop = 1;
        $_data_length = count($ptbam_getdata_result);
    ?>
    <?php foreach ($ptbam_getdata_result as $value) { ?>
  <tr>
           ...
           <td><?php echo $_idx_loop ?></td>
               ...
               <td hidden>
                  ...
                  <input  value="<?php echo $value->id_pt_bam ?>"   name="id_pt_bam[]" style="border: 0;background-color: transparent;width:100%">
              </td>
               <td>
       ...
       <td class="total6"><input value ="<?php echo $value->total_ABC ?>" readonly=""  id="total_ABC" name="total_ABC" style="border: 0;background-color: transparent;width:100%" ></td>
                    ...
                    <table  class="tablex table-bordered table-striped table-hover" id="table2">
                        ...
                        <tbody>
                             ...
                             <?php $_idx_loop = 1; $_data_length = count($ptbam_getdata_result); ?>
                            <?php foreach ($ptbam_getdata_result as $key) { ?>
                        <tr>
                                
                            <td><?php echo $_idx_loop; ?></td>
                            <td>
                                <textarea name="tipe_jaminan_agunan[]"   rows="1"style="background-color:transparent"><?php echo $value->tipe_jaminan ?></textarea>
                            
                             </td>
                         
                            <td>
                                <textarea  name="desc_agunan[]" rows="8" style="background-color:transparent"><?php echo $value->desk_agunan ?></textarea>
                               
                            </td>
                            <td>
                                <input class="qty7" value="<?php echo $value->mv_lama ?>"   name="mv_lama[]" style="width:100%!important; border: 0;background-color:transparent">
                            </td>
                            <td>
                                <input class="qty8" value="<?php echo $value->lv_lama ?>"   name="lv_lama[]" style="width:100%!important; border: 0;background-color:transparent">
                                
                            </td> 
                             <td>
                                 <input class="qty9" value="<?php echo $value->mv_baru ?>"   name="mv_baru[]" style="width:100%!important; border: 0;background-color:transparent">
                                 
                             </td>
                            <td>
                                <input class="qty10" value="<?php echo $value->lv_baru ?>"   name="lv_baru[]" style="width:100%!important; border: 0;background-color:transparent">
                            </td> 
                            <td>
                                <textarea name="ket_appraisal[]"   rows="8" style="width:100%!important; border: 0;background-color:transparent"><?php echo $value->ket_appraisal ?></textarea>
                      ...
                      <tr>
                            ...
                            <td><input class="total7" value="<?php echo $getdata_ptbam_row -> total_mv_lama  ?>" readonly="" name="total_mv_lama" style="width:100%;background-color:transparent"></td>
                            <td><input class="total8" value="<?php echo $getdata_ptbam_row -> total_lv_lama; ?>" readonly="" name="total_lv_lama" style="width:100%;background-color:transparent"></td>
                            <td><input class="total9" value="<?php echo $getdata_ptbam_row -> total_mv_baru; ?>" readonly="" id="total_mv_baru" name="total_mv_baru" style="width:100%;background-color:transparent"></td>
                            <td><input class="total10" value="<?php echo $getdata_ptbam_row -> total_lv_baru;?>" readonly="" id="total_lv_baru" name="total_lv_baru"style="width:100%;background-color:transparent"></td>
                            <td></td>
                ...
                <div class="col-sm-11">
                                            ...
                                            <table class="tablex table-bordered table-striped table-hover" id="table2">
                                                ...
                                                <tbody>
                                                    <?php $_idx_loop = 1; $_data_length = count($pengajuanpelunasan); ?>
                                                    <?php if(!empty($pengajuanpelunasan)){ ?>
                                                    <?php $fs_idx = 0; ?>
                                                    <?php
                                                    $i = 0;
                                                    foreach ($pengajuanpelunasan  as $value) { ?>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input value="<?php echo $getdata_ptbam_row->grand_tltkewajiban ?>" class="tlt1"name="Grand_tltkewajiban" id="grandTotalKewajiban" readonly=""   data-index="<?php echo $fs_idx; ?>"></td>
                                                        <td><input value="<?php echo $getdata_ptbam_row->grand_ttldibayar ?>" class="tlt2"name="Grand_ttldibayar" id="grandTotalDibayar"  readonly="" ></td>
                                                        <td><input value="<?php echo $getdata_ptbam_row->grand_ttlsisakewajiban ?>" class="ttlhpstgh"name="Grand_ttlsisakewajiban" id="grandTotalSisaKewajiban" readonly="" ></td>
                                                        <td><input value="<?php echo $getdata_ptbam_row->grand_ttlsisahapustagih ?>" class="hpstghtotal"name="Grand_ttlsisahapustagih" id="grandTotalSisaHapusTagih" readonly="" ></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div> 
                ...
                <div class="form-group row">
                     <div class="col-sm-11">
                       ...
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote2"><?php echo $getdata_ptbam_row->catatan_kondisi_penyelesaian ?></div>
                        </div>
        ...
        <button type="button" id="btnAdd[]" class="button-add"onClick="myDeleteFunction()" value="add">Delete</button>
                ...
                <div class="form-group">
                  <div class="col-sm-11">
                       ...
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote5"><?php echo $getdata_ptbam_row->permasalahan_debitur ?></div>
                        </div>
...
<!--                            <tr>
                   ...
                   <div class="col-sm-11">
                       ...
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote8"><?php echo $getdata_ptbam_row->dasar_pertimbangan ?></div>
                        </div>
                ...
                <div class="col-sm-11">
                       ...
                       <div class="col-lg-10 col-md-9"style="width: 96%; ">
                        <div style=" height: 50%;" id="" class="summernote10"><?php echo $getdata_ptbam_row->rekomendasi_penyelesaian_kredit ?></div>
                        </div>
