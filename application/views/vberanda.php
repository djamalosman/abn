                ...
                <div  class="panel panel-danger toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-body">
                        <div class="row profile">
                            <div class="panel-body">
                                <form action="<?php echo base_url('Home/insert_Imagedelete'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-4 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <button type="submit" name="update" id="insert"  style="background-color: #1f3983;" class="btn btn-success btn-sm mr5 mb10" >  <span class="text"> insert</span></button>
                                                    <button type="submit" name="delete" id="delete"  style="background-color: #1f3983;" class="btn btn-success btn-sm mr5 mb10" >  <span class="text"> Delete</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
