                    ...
                    <div class="panel panel-success ">
                        <div class="row">
                            <div class="col-md-12 mx-auto">
                                <form action="<?php echo base_url('Create_document_tokoh/update_doctokoh') ?>" method="POST"
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-11">
                                                <br>
                                                    ...
                                                    value="<?php echo $v_datatokoh->id_doctokoh ?>" title="erorr" align="right"
                                                    class="form-control" type="hidden" placeholder="Judul" required ">
                                                    <input  name="code_image" id="code_image" autocomplete="off"
                                                    value="<?php echo $v_datatokoh->code_image ?>" title="erorr" align="right"
                                                    class="form-control" type="hidden" placeholder="Judul" required ">
                                                    <input name="jabatan" id="jabatan" autocomplete="off"
                                                    value="<?php echo $v_datatokoh->jabatan ?>"  align="right"
                                                    ...
                                                    value="<?php echo $v_datatokoh->nama_asli ?>"  align="right"
                                ...
                                <div class=" col-lg-11 col-md-9"style="width: 112%; ">
                                                <div style=" height: 50%;" id="" class="summernote1">
                                                    <?php echo $v_datatokoh->description ?></div>
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-sm-12">
                                ...
                                <div class="panel panel-success ">
                                    ...
                                    <div class="panel-body">
                                        <input type='file' value="<?php echo base_url('uploads/' . $v_datatokoh->file_content)?>" multiple="multiple" required="" class="form-control"
                                            id="blah[]" name="myfile[]" onchange="readURL(this);" /><img id="blah"
                                            src="<?php echo base_url('uploads/' . $v_datatokoh->file_content)?>"
                                            alt="your image" />
