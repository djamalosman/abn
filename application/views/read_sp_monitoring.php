            ...
            <div class="col-lg-12">
                <div class="panel panel-danger toggle panelMove panelClose panelRefresh">
                    <div class="panel-heading" style="background-color: red;">
                        <h4 class="panel-title"><i class="fa fa-files-o"></i>SP Monitoring</h4>
                    </div>
                    <div class="panel-body">
                        <div class="form-group" >
                            <div class="col-lg-12" style="margin-bottom: 20px;">
                                 <a href='<?php echo base_url("downloadexcel/excel_monitoringsp"); ?>' type="button" style="background-color: #0bacd3; height: 29px" class="btn btn-primary"><i class="fa fa-download"></i>  Download Excel</a>
                            </div>
                        </div>
                                    ...
                                    <?php foreach ($sp as $item) { ?>
                                        <tr>
                                            <td><a title="Edit" data-toggle="modal" data-target="#modals4" 
                                                   ...
                                                   data-namaup = '<?php echo $item->f_nama_up; ?>'
                                                   data-jabatanup = '<?php echo $item->f_jabatan_up; ?>'

                                                   ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </a> <a title="Cetak" <?php
                                                if ($item->f_nama_asign_1 == '') {
                                                    echo "href = '#'";
                                                } else {
                                                    echo 'href =' . base_url('sp/update_cetak/' . $item->f_id);
                                                }
                                        ...
                                        if ($item->f_status == 0) {
                                            ...
                                            ?>
                                                ><i class="glyphicon  glyphicon-eye-close"></i> 
                                                    ...
                                                    echo "href= '" . base_url('generatepdf/index/' . $item->f_id . '/' . $item->f_sp) . "' target = '_blank'";
                                                    ?>
...
<div  class="modal fade" id="modals1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-center">
        <form action=" <?php echo base_url('sp/update_trima'); ?>" method="post">
            ...
            <div class="modal-content" style="width: 350px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-4">
                        <textarea id="ket" name="ket" type="text" required="required" class=" form-control" placeholder="keterangan" style="width: 200px;" ></textarea>
                    </div>
...
<div  class="modal fade" id="modals2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-center">
        <form action=" <?php echo base_url('sp/update_kirim'); ?>" method="post">
            ...
            <div class="modal-content" style="width: 350px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-4">
                        <textarea id="ket" name="ket" required="required" type="text" class=" form-control" placeholder="keterangan" style="width: 200px;" ></textarea>
                    </div>
...
<div  class="modal fade" id="modals3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-center">
        <form action=" <?php echo base_url('sp/percepatan'); ?>" method="post">
...
<div  class="modal fade" id="modals4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-center">
        <form action=" <?php echo base_url('sp/asignsp'); ?>" method="post">
            ...
            <div class="modal-content" >
                <div class="modal-header" style="background-color: red;">
                    ...
                    <h4 class="modal-title" id="mySmallModalLabel" style="color: white"><i class="fa fa-send"></i>  Asign SP</h4>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        <div class="col-lg-6">
                            <div style="width: 130px;"class="col-lg-1">
                                <label class=" control-label"> Jabatan 1</label>
                    ...
                    <div class="col-lg-12" style="margin-top: 10px; margin-bottom: 20px;">
                        <div class="col-lg-6">
                            <div style="width: 130px;"class="col-lg-1">
                                <label class=" control-label"> Jabatan 2</label>

                            </div>
                            <div class="col-lg-12">
                                <select name="jabatan2" id="jabatan2" class="form-control" required="">
                                    <?php foreach ($jabatan as $a) { ?>      
                                        <option value="<?php echo $a->f_desc ?>"><?php echo $a->f_desc ?></option>   
                                    <?php } ?>        
                                </select>     
					...
					<div class="col-lg-12" style="margin-top: 10px; margin-bottom: 20px;">
											<div class="col-lg-6">
												<div style="width: 130px;"class="col-lg-1">
													<label class=" control-label">UP Jabatan</label>

												</div>
												<div class="col-lg-12">
													<input name="upjabatan" class="form-control" id="jabatanup" title="Format Tidak Mendukung" pattern="[a-zA-Z0-9/.& ,-]+"   type="text">                    
												</div>
											</div>
											<div class="col-lg-6">
												<div style="width: 130px;"class="col-lg-1">
													<label class=" control-label">UP Nama </label>
												</div>
												<div class="col-lg-12">
													<input name="upnama" class="form-control" id="namaup" title="Format Tidak Mendukung" pattern="[a-zA-Z0-9/.& ,-]+"   type="text">                  
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#modals4').on('show.bs.modal', function (event) {
            ...
            modal.find('#jabatan2').val(div.data('jabatan2'));
            modal.find('#namaasign2').val(div.data('namaasign2'));
            modal.find('#namaup').val(div.data('namaup'));
            modal.find('#jabatanup').val(div.data('jabatanup'));
            //$('#jenissp1').trigger('change');//.change();//trigger('update.fs');//.selectpicker("refresh");
        });
