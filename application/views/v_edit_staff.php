                    ...
                    <div class="panel panel-success ">
                        <div class="row">
                            <div class="col-md-12 mx-auto">
                                <form action="<?php echo base_url('Create_document_staff/update_docstaff') ?>" method="POST"
                                        ...
                                        <div class="panel-body">
                                            <div class="panel-heading" style="background-color:#1f3983">
                                                <h4 class="panel-title " style="color:white"><i
                                                        ...
                                                        ;></i><?php echo $pagename ?></h4>
                                            </div>
                                            <div class="col-sm-11">
                                            <br>
                                                    <input  name="id_docagenda" id="id_docagenda" autocomplete="off"
                                                    value="<?php echo $v_datastaff->id_docstaff ?>" title="erorr" align="right"
                                                    class="form-control" type="hidden" placeholder="Judul" required ">
                                                    <input  name="code_image" id="code_image" autocomplete="off"
                                                    value="<?php echo $v_datastaff->code_image ?>" title="erorr" align="right"
                                                    class="form-control" type="hidden" placeholder="Judul" required ">
                                                    <input name="jabatan" id="jabatan" autocomplete="off"
                                                    value="<?php echo $v_datastaff->jabatan ?>"  align="right"
                                                    class="form-control" type="text" placeholder="Jabatan Sekarang atau terakhir menjabat" required ">
                                                    <br>
                                                    <br>
                                                    <input name="nama_asli" id="nama_asli" autocomplete="off"
                                                    value="<?php echo $v_datastaff->nama_asli ?>"  align="right"
                                                    class="form-control" type="text" placeholder="Nama Lengkap" required ">
                                                <br>
                                <div class=" col-lg-11 col-md-9"style="width: 112%; ">
                                                <div style=" height: 50%;" id="" class="summernote1">
                                                    <?php echo $v_datastaff->description ?></div>
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-sm-12">
                                ...
                                <div class="panel panel-success ">
                                    ...
                                    <div class="panel-body">
                                        <input type='file' value="<?php echo base_url('uploads/' . $v_datastaff->file_content)?>" multiple="multiple" required="" class="form-control"
                                            id="blah[]" name="myfile[]" onchange="readURL(this);" /><img id="blah"
                                            src="<?php echo base_url('uploads/' . $v_datastaff->file_content)?>"
                                            alt="your image" />
                                    ...
                                    <a href="<?php echo base_url ('agenda')?>" button type="submit"
