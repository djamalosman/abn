            ...
            <div class="col-lg-12 col-md-4 col-sm-12">
                <div  class="panel panel-danger toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-heading" style="background-color: red;">
                        <h4 class="panel-title"><i class="glyphicon glyphicon-list-alt"></i>Dokumen Lelang</h4>
                    </div>
                    <div class="panel-body">
                        <div class="row profile">
                            ...
                            <div class="panel-body">
                                <form action="<?php echo base_url('lelang/updateImagedelete'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix" hidden="">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="id" id="id" class="form-control" value="<?php echo $imageview->id_t_lelang ?>" placeholder="id" required="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row clearfix" hidden="">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="cif" id="cif" class="form-control" value="<?php echo $imageview->cif ?>" placeholder="cif" required="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
