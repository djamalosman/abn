        ...
        <div class="col-lg-12">
            <div class="panel panel-danger toggle panelMove panelClose panelRefresh">
                ...
                <div class="panel-body">
                    <form name="myform" action="<?php echo base_url('Create_document/mrpk_perpanjangan_view_create')?>"
                        ...
                        <div class=" form-group">
                            ...
                            <div class="modal">
                                ...
                                <?php $arrax = array(); ?>
                                <?php foreach ($searchmrpkperpanjangan as $value) { $arrax[] = $value->NomorNasabah . '-' . $value->NamaDebitur;} ?>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <table id="example"
                                        ...
                                        <tr>
                                            <td>
                                                <a title="Delete"
                                                    href="<?php echo base_url("Create_document/delete_deb_mrpk_perpanjangan/".$item->cif.'-'.$item->id_mrpk_perpanjangan) ?>"><i
                                                        class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                <a title="Edit"
                                                    href="<?php echo base_url("Create_document/mrpk_perpanjangan_view_edit/".$item->cif.'-'.$item->id_mrpk_perpanjangan) ?>"><i
                                                        class="fa fa-pencil" aria-hidden="true"></i></a>
                                                <!--<a title="Edit" href="<?php echo base_url("content/edit_mrpk_pelunasan/".$item->cif) ?>"><i class="fa fa-list" aria-hidden="true"></i></a>-->
                                                <a title="preview"
                                                    href="<?php echo base_url("LaporanPdf/perpanjangan/".$item->cif.'-'.$item->id_mrpk_perpanjangan) ?>"
