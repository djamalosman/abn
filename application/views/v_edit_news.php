                    ...
                    <div class="panel panel-success ">
                        <div class="row">
                            <div class="col-md-12 mx-auto">
                                <form action="<?php echo base_url('Create_document/update_docnews') ?>" method="POST"
                                        ...
                                        <div class="panel-body">
                                            <div class="panel-heading" style="background-color:#1f3983">
                                                <h4 class="panel-title " style="color:white"><i
                                                        ...
                                                        ;></i>Insert Data News</h4>
                                            </div>
                                            <div class="col-sm-11">
                                                <br>

                                                    <input  name="id_docnews" id="id_docnews" autocomplete="off"
                                                    value="<?php echo $v_datanews->id_docnews ?>" title="erorr" align="right"
