        ...
        <div id="content">
            ...
            <section class="portfolio portfolio-4-columns white-bg">
                ...
                <div class="projects relative ovh">
                    <?php foreach ($all_doc_agenda as $doc_agenda ) { ?>
                            <div class="img-holder mix other">
                                <!-- col-md-3 start here -->
                                <div class="bg-img-holder">
                                    <<img src="<?php echo base_url('uploads/' . $doc_agenda->file_content)?>" alt="blog post">
                                </div>
                                <div class="img-hover text-center">
                                    <a href="<?php echo base_url("C_one_doc_agenda/v_one_agenda/" . $doc_agenda->code_image . '-' . $doc_agenda->id_docagenda) ?>">
                                        <div class="img-hover-content">
                                            <h5><?php echo $doc_agenda->judul ?></h5>
